...
import {
  getStudent, updateStudent, resetStudentForm,
...
const EditStudent = props => {
  ...
  const onSubmit = data => updateStudent(data, dispatch);
      ...
      <div className="card-body">
        <div className="heading-layout1">
          <div className="item-title">
            <h3>
              { student && student.id ? 'Update ' : 'Add New '}
              Student
            </h3>
          </div>
        ...
        <form className="new-added-form" onSubmit={handleSubmit(onSubmit)}>
          <div className="row">
            ...
            <input
              name="id"
              type="hidden"
              defaultValue={(student && student.id) || undefined}
              ref={register()}
            />
            ...
            <div className="col-xl-3 col-lg-6 col-12 form-group">
              ...
              <input
                ...
                defaultValue={(student && student.first_name) || undefined}
            ...
            <div className="col-xl-3 col-lg-6 col-12 form-group">
              ...
              <input
                ...
                defaultValue={(student && student.middle_name) || undefined}
                ref={register({ required: true })}
              />
              { errors.middle_name
               && <span className="text-danger">This Field is Required </span> }
            ...
            <div className="col-xl-3 col-lg-6 col-12 form-group">
              ...
              <input
                ...
                defaultValue={(student && student.last_name) || undefined}
                ref={register({ required: true })}
              />
            ...
            <div className="col-xl-3 col-lg-6 col-12 form-group">
              ...
              <select
                ...
                name="gender"
                defaultValue={(student && student.gender) || undefined}
                ref={register({ required: true })}
              >
            ...
            <div className="col-xl-3 col-lg-6 col-12 form-group">
              ...
              <input
                ...
                name="date_of_birth"
                defaultValue={(student && dateFormat(student.date_of_birth)) || undefined}
                ref={register({ required: true })}
              />
            ...
            <div className="col-xl-3 col-lg-6 col-12 form-group">
              ...
              <select
                ...
                name="role_ids[0]"
                readOnly
                defaultValue={(student && `${student.role_id}`) || undefined}
                ref={register({ required: true })}
              >
            ...
            <div className="col-xl-3 col-lg-6 col-12 form-group">
              ...
              <select
                ...
                name="marital_status"
                defaultValue={(student && student.marital_status) || undefined}
                ref={register({ required: true })}
              >
            ...
            <div className="col-xl-3 col-lg-6 col-12 form-group">
              ...
              <select
                ...
                name="blood_type"
                defaultValue={(student && student.blood_type) || undefined}
                ref={register({ required: true })}
              >
                <option value="">Please Select Group *</option>
            ...
            <div className="col-xl-3 col-lg-6 col-12 form-group">
              ...
              <input
                ...
                defaultValue={(student && student.email) || undefined}
                ref={register({ required: true })}
              />
            ...
            <div className="col-xl-3 col-lg-6 col-12 form-group">
              ...
              <input
                ...
                defaultValue={(student && student.no_control) || undefined}
                ref={register({ required: true })}
              />
            </div>
            ...
            <div className="col-xl-3 col-lg-6 col-12 form-group">
              ...
              <input
                ...
                defaultValue={(student && student.curp) || undefined}
                ref={register({ required: true })}
              />
            ...
            <div className="col-xl-3 col-lg-6 col-12 form-group">
              ...
              <input
                ...
                defaultValue={(student && student.home_phone) || undefined}
                ref={register({ required: true })}
              />
            </div>
            ...
            <div className="col-xl-3 col-lg-6 col-12 form-group">
              ...
              <input
                ...
                defaultValue={(student && student.mobile_phone) || undefined}
                ref={register({ required: true })}
